...
<html lang="es">
<head>
    <title>Registrar Centro Sanitario MSP</title>
    <?php
        session_start();
        $LinksRoute="../";
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema Gestión Ambiental <small>Añadir Centro Sanitario MSP</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para agregar nuevos centros sanitarios, deberas de llenar todos los campos para poder registrar.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <form action="../process/AddMSP.php" method="POST" id="saveData" autocomplete="off" enctype="multipart/form-data">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Nuevo Centro Sanitario MSP</div>
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <legend><strong>FICHA</strong></legend><br>
                            <div class="group-material">
                                <input type="text" class="tooltips-general material-control" placeholder="Escribe aquí el RUC" name="bookCodeManual" pattern="[a-zA-Z0-9-]{1,100}" maxlength="100" data-toggle="tooltip" data-placement="top" title="Solamente números">
                            ...
                            <div class="group-material">
                                <input type="text" class="tooltips-general material-control" placeholder="Escribe aquí el representante " name="bookAutor"  maxlength="500" data-toggle="tooltip" data-placement="top" title="Escribe el número de contacto">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Representante Legal</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="tooltips-general material-control" placeholder="Escribe aquí un telefono"  name="bookCountry" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el sector donde vive">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Celular</label>
                            </div>
                            ...
                            <div class="group-material">
                                ...
                                <select class="tooltips-general material-control" name="bookProvider" data-toggle="tooltip" data-placement="top" title="Elige el gestor">
                                    <option value="" disabled="" selected="">Elija una zona</option>
                                    <?php
                            ...
                            <div class="group-material">
                               <input type="text" class="material-control tooltips-general" placeholder="Escribe una Email" name="bookYear"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe una referencia">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <div class="group-material">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el N° de pacientes al día" name="bookEditorial" maxlength="70" data-toggle="tooltip" data-placement="top" title="Dias de Hemodiálisis">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>N° de pacientes al dia</label>
                            </div>

                            <legend><strong>DESECHOS GENERADOS</strong></legend><br>
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general"  placeholder="Escribe aquí la disposición final" name="bookIdioma"  maxlength="90" data-toggle="tooltip" data-placement="top" title="Horario de Salida" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
...
<!--
                            ...
                            <legend><strong>Foto del Centro Sanitario y archivo PDF</strong></legend><br>
                            <div class="group-material">
