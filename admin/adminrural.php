                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí los N° de pacientes" name="bookEditorial" maxlength="70" data-toggle="tooltip" data-placement="top" title="Dias de Hemodiálisis">
                                <span class="highlight"></span>
                                <span class="bar"></span>
