...
$pdf->Cell (0,5,utf8_decode('Inventario general de Centros Sanitarios MSP '.$dataInstitution['Year'].''),0,1,'C');
$pdf->Ln(12);
...
while($DSAC=mysqli_fetch_array($SAC, MYSQLI_ASSOC)){
    $SABC=ejecutarSQL::consultar("SELECT * FROM msp WHERE CodigoCategoria='".$DSAC['CodigoCategoria']."' ORDER BY Titulo ASC");
