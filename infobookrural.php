...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        $checkBookCode= ejecutarSQL::consultar("SELECT * FROM rural WHERE CodigoLibro='".$codeBook."'");
                ...
                <div class="col-xs-12">
                    <?php
                        if($_SESSION['UserPrivilege']=='Student'||$_SESSION['UserPrivilege']=='Teacher'||$_SESSION['UserPrivilege']=='Personal'){
                            ...
                            include './inc/infoBookAdminRural.php';
                        }
                    ?>
                </div>
...
-->
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="modal-content" action="process/UpdateBookRural.php" method="POST" id="saveData" autocomplete="off" enctype="multipart/form-data">
